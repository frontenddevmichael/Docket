...
export type IconName =
  ...
  | 'flag' | 'filter-list' | 'lock' | 'note' | 'person-add' | 'folder'
  | 'lightbulb' | 'analytics' | 'delete'
...
const icons: Record<IconName, (props: SVGProps<SVGSVGElement>) => React.ReactElement> = {
  'assignment': (p) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...p}>
      ...
      <path d="M9 14h.01M13 14h2M9 17h.01M13 17h2" />
    </svg>
  ),
  'description': (p) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...p}>
  ...
  'bug-report': (p) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...p}>
      ...
      <path d="M12 20v-9M6.53 9C4.6 8.8 3 7.1 3 5M6 13H2M3 21c0-2.1 1.7-3.9 3.8-4M20.97 5c0 2.1-1.6 3.8-3.5 4M22 13h-4M17 17h4" />
    </svg>
  ),
  'eye-off': (p) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...p}>
